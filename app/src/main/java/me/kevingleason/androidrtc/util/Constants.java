...
public class Constants {
    ...
    public static final String PUB_KEY = "pub-c-2f8a09a1-a1ea-4a69-9cd3-2f76f9965ddc"; // Your Pub Key
    public static final String SUB_KEY = "sub-c-d5af4334-c799-11eb-9e40-ea6857a81ff7"; // Your Sub Key
